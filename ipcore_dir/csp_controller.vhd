...
-- /___/   /\     Timestamp: Wed Dec 04 17:13:29 2013
-- \   \  /  \ 
--  \___\/\___\
--             
-- Command	: -w -sim -ofmt vhdl C:/Users/odmb/Documents/LocalFW/odmb_ucsb_v2/ipcore_dir/tmp/_cg/csp_controller.ngc C:/Users/odmb/Documents/LocalFW/odmb_ucsb_v2/ipcore_dir/tmp/_cg/csp_controller.vhd 
-- Device	: xc6vlx130t-ff1156-1
-- Input file	: C:/Users/odmb/Documents/LocalFW/odmb_ucsb_v2/ipcore_dir/tmp/_cg/csp_controller.ngc
-- Output file	: C:/Users/odmb/Documents/LocalFW/odmb_ucsb_v2/ipcore_dir/tmp/_cg/csp_controller.vhd
-- # of Entities	: 1
-- Design Name	: csp_controller
...
architecture STRUCTURE of csp_controller is
  ...
  signal U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O23 : STD_LOGIC; 
  signal U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O231_260 : STD_LOGIC; 
  signal U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O23_f7_261 : STD_LOGIC; 
...
begin
  CONTROL0(2) <= CONTROL4(2);
  CONTROL0(1) <= CONTROL4(1);
  CONTROL0(0) <= CONTROL4(0);
  CONTROL1(2) <= CONTROL4(2);
  CONTROL1(1) <= CONTROL4(1);
  CONTROL1(0) <= CONTROL4(0);
  CONTROL2(2) <= CONTROL4(2);
  CONTROL2(1) <= CONTROL4(1);
  CONTROL2(0) <= CONTROL4(0);
  CONTROL3(2) <= CONTROL4(2);
  CONTROL3(1) <= CONTROL4(1);
  CONTROL3(0) <= CONTROL4(0);
  XST_VCC : VCC
    port map (
      P => N0
    );
  ...
  U0_U_ICON_U_TDO_reg : FDE
    ...
    port map (
      C => CONTROL4(0),
      CE => N0,
      D => U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O23_f7_261,
      Q => U0_U_ICON_iTDO
    );
  ...
  U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O231 : LUT6
    generic map(
      INIT => X"AA0000D8000000D8"
    )
    port map (
      I0 => U0_U_ICON_iCORE_ID(0),
      I1 => CONTROL3(3),
      ...
      I4 => U0_U_ICON_iCORE_ID(3),
      I5 => U0_U_ICON_iTDO_VEC(15),
      O => U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O23
    );
  U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O232 : LUT6
    generic map(
    ...
    port map (
      ...
      I4 => CONTROL1(3),
      I5 => CONTROL4(3),
      O => U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O231_260
    );
  U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O23_f7 : MUXF7
    port map (
      I0 => U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O231_260,
      I1 => U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O23,
      S => U0_U_ICON_iCORE_ID(1),
      O => U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O23_f7_261
    );
